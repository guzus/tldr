document.addEventListener("DOMContentLoaded", () => {
    ...
    // Load saved API key, language, and summary on popup open
    chrome.storage.local.get(["openaiApiKey", "selectedLanguage", "elevenLabsApiKey", "summary"], (result) => {
        ...
        if (result.summary) {
            outputTextarea.value = result.summary; // Load saved summary
        }
    });
